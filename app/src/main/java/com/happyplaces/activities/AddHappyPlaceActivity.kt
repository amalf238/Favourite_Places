...
class AddHappyPlaceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       /* if (!Places.isInitialized()) {
            Places.initialize(
                    this@AddHappyPlaceActivity, getString(R.string.google_maps_api_key)
            )
        } */
        if (!Places.isInitialized()) {
            Places.initialize(
                applicationContext, getString(R.string.google_maps_api_key)
            )
        }
        ...
        // creating the OnDateSetListener for date
        // setters for year, month and date
        dateSetListener =
                DatePickerDialog.OnDateSetListener { view, year, monthOfYear, dayOfMonth ->
                    ...
                    updateDateInView() // updates the date view with the selected date
                }
        ...
        et_location.setOnClickListener(this) // location set on click listner to open the Google places api
        tv_select_current_location.setOnClickListener(this)
    }

    override fun onClick(v: View?) {
        when (v!!.id) {
            R.id.et_date -> { // lamda expression use
                DatePickerDialog(
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == PLACE_AUTOCOMPLETE_REQUEST_CODE) {
            if (resultCode == Activity.RESULT_OK && data != null) {
                ...
                val status: com.google.android.gms.common.api.Status = Autocomplete.getStatusFromIntent(data)
                Log.e("Autocomplete Error", status.statusMessage ?: "Unknown error")
                Toast.makeText(this, "Error: ${status.statusMessage}", Toast.LENGTH_SHORT).show()
            } else if (resultCode == Activity.RESULT_CANCELED) {
                Log.e("Autocomplete Canceled", "User canceled autocomplete")
            }
    ...
    /* public override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            else if (requestCode == PLACE_AUTOCOMPLETE_REQUEST_CODE) { // if a place is entered and we get something back that's what we want to display
    ...
    private fun updateDateInView() {
        val myFormat = "dd.MM.yyyy" // mention the format needed
    ...
    private val mLocationCallback = object : LocationCallback() {
        override fun onLocationResult(locationResult: LocationResult) {
            ...
            if(mLastLocation != null){
                ...
                Log.e("Location Error", "Last known location is null")
                Toast.makeText(this@AddHappyPlaceActivity, "Unable to get current location", Toast.LENGTH_SHORT).show()
            }
    ...
    companion object {
        ...
        // A constant variable to pick a place
